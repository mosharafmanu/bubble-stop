...
// Render
if ( $video_data && function_exists( 'bubble_stop_render_video' ) ) {
    bubble_stop_render_video( $video_data, [
        'behavior'        => 'autoplay',
        'autoplay'        => true,
        'muted'           => true,
        'loop'            => true,
...
```php
bubble_stop_render_video( $video_field, $args = [] )
```
...
--bubb-color-accent  /* button background */
--bubb-color-light   /* button border */
```
