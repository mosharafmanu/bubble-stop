...
if ( ! function_exists( 'bubble_stop_render_button' ) ) {
	function bubble_stop_render_button( $button_link, $args = [] ) {
...
if ( ! function_exists( 'bubble_stop_render_buttons' ) ) {
	function bubble_stop_render_buttons( $buttons, $args = [] ) {
