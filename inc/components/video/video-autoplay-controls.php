...
if ( ! function_exists( 'bubble_stop_render_video_autoplay_controls' ) ) {
	 ...
	 */
	function bubble_stop_render_video_autoplay_controls( $args = [] ) {
		$defaults = [
			'class' => '',
			'echo'  => true,
		];
		...
		$html .= '<button class="video-control-btn video-play-pause-btn" aria-label="' . esc_attr__( 'Play/Pause', 'bubble-stop' ) . '">';
		$html .= bubble_stop_render_video_control_icon( 'play' );
		$html .= bubble_stop_render_video_control_icon( 'pause' );
		$html .= '</button>';

		// Mute/Unmute Button - Both icons inside
		$html .= '<button class="video-control-btn video-mute-btn" aria-label="' . esc_attr__( 'Mute/Unmute', 'bubble-stop' ) . '">';
		$html .= bubble_stop_render_video_control_icon( 'unmute' );
		$html .= bubble_stop_render_video_control_icon( 'mute' );
		$html .= '</button>';
...
if ( ! function_exists( 'bubble_stop_render_video_control_icon' ) ) {
	/**
	 ...
	 */
	function bubble_stop_render_video_control_icon( $icon ) {
		$icons = [
