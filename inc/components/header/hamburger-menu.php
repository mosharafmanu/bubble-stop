...
if ( ! function_exists( 'bubble_stop_render_mobile_navigation' ) ) {
	function bubble_stop_render_mobile_navigation() {
		...
		<nav id="mobile-navigation" class="mobile-navigation" aria-label="<?php esc_attr_e( 'Mobile navigation', 'bubble-stop' ); ?>" aria-hidden="true">
			<div class="mobile-nav-inner">
				...
				<div class="mobile-nav-header">
					...
					<button class="mobile-menu-close" aria-label="<?php esc_attr_e( 'Close menu', 'bubble-stop' ); ?>">
						<span></span>
						<span></span>
					</button>
				</div>
				...
				<div class="mobile-nav-social">
					<?php
					// Reuse the same helper the footer calls (bubble_stop_render_social_medias)
					...
					bubble_stop_render_social_medias( [
