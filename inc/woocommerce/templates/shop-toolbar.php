...
<div class="shop-toolbar">
	<div class="shop-toolbar-inner">
		<div class="filters-section">
			<button class="filter-toggle-btn" aria-label="<?php esc_attr_e( 'Toggle Filters', 'bubble-stop' ); ?>">
				<div class="filters-label">
					<span class="filter-icon"><?php get_template_part( 'assets/svgs/filter-icon' ); ?></span>
					<span><?php esc_html_e( 'Filters', 'bubble-stop' ); ?></span>
				</div>
				<div class="filter-toggle-text-wrapper">
					<span class="filter-toggle-text"><?php esc_html_e( 'Hide filters', 'bubble-stop' ); ?></span>
	...
	<div class="result-count-wrapper-mobile">
		<!-- Result count is moved here on mobile/tablet via bubble-stop-shop-archive.js -->
	</div>
</div>
