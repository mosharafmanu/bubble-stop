 ...
 * argument (handled by bubble-stop-shop-archive.js); the resulting
 * request is turned into a tax_query by bubble_stop_filter_shop_products_by_category()
...
<div class="product-filters">
	...
	<button class="filters-close-btn" aria-label="<?php esc_attr_e( 'Close Filters', 'bubble-stop' ); ?>">
		...
		<div class="filter-group">
			<ul class="filter-list">
				...
				<li class="filter-item">
					...
					>
						<span class="filter-name"><?php esc_html_e( 'All Products', 'bubble-stop' ); ?></span>
	...
	<?php if ( $has_active_filters ) : ?>
		<div class="clear-filters-wrapper">
			<a href="<?php echo esc_url( $clear_filters_url ); ?>" class="clear-filters-btn">
				<?php esc_html_e( 'Clear Filters', 'bubble-stop' ); ?>
			</a>
		</div>
	<?php endif; ?>
