...
Bubble Stop is a personal WordPress theme framework built for repeatable custom ACF-based projects. It is not a theme you activate and use out of the box. It is a starting point that you configure and build on top of for each client.
...
Bubble Stop ships with a self-contained, removable WooCommerce module —
...
| Convention | Value |
|---|---|
| Function prefix | `bubble_stop_` |
| Text domain | `bubble-stop` |
| CSS token prefix | `--bubb-` |
