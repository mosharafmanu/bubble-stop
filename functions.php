...
function bubble_stop_scripts() {
    ...
    wp_enqueue_script('bubble-stop-menu-carousel', get_template_directory_uri() . '/assets/js/bubble-stop-menu-carousel.js', array('jquery', 'slick-carousel'), BUBBLE_STOP_VERSION, true);
    wp_enqueue_script('bubble-stop-menu-scroll', get_template_directory_uri() . '/assets/js/bubble-stop-menu-scroll.js', array('jquery'), BUBBLE_STOP_VERSION, true);
