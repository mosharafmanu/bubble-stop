...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'single-post' ); ?>>
	...
	?>
		<div class="post-thumbnail">
			<?php if ( function_exists( 'bubble_stop_render_responsive_picture' ) ) :
				...
				the_post_thumbnail( 'bubb-1200', [ 'class' => 'post-thumbnail-image' ] );
			endif; ?>
		</div>
	<?php endif; ?>
		...
		<div class="entry-content mt-50 mt-md-60">
			...
			the_content( sprintf(
				wp_kses(
					...
					__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'bubble-stop' ),
					[ 'span' => [ 'class' => [] ] ]
				),
			...
			wp_link_pages( [
				'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'bubble-stop' ),
				'after'  => '</div>',
			] );
			?>
		</div>
