...
<section class="blog-hero layout-padding">
	...
	<?php if ( 'video' === $media_type && $video && function_exists( 'bubble_stop_render_video' ) ) : ?>
		<div class="blog-hero-media">
			<?php bubble_stop_render_video( $video, [ 'behavior' => 'autoplay', 'lazy' => false ] ); ?>
		</div>
	<?php elseif ( 'image' === $media_type && $image && function_exists( 'bubble_stop_render_responsive_picture' ) ) : ?>
		<div class="blog-hero-media">
			<?php
